...
- **Data portability and comparison**: Exported JSON files should be re-importable as new local drafts. A dedicated comparison view should let users compare 2+ published forms from the same parent template side by side. Comparison columns should show respondent names (not form titles). The compare page should not evaluate agreement/disagreement — just show raw answers. (F-018, superseded partially by F-023)
