...
- **Onboarding and accessibility clarity**: The app should better explain its purpose and help new users understand what to do first; templates should include concise descriptions to put users in the right mindset; response-option meanings must be visible on mobile/touch devices without relying on hover. (F-004, F-030, F-031)
